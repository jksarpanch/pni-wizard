...
var PopulateWizard = (function () {
    function PopulateWizard() {
        ...
        this.questionList = [];
        this.tracking = false;
        this.isImageGamification = false;
        ...
        this.renderImageGamification = function () {
            _this.dynamicImages.wizardWrapper();
        };
        ...
        this.openInteractiveWizard = function () {
            ...
            if (wizardContainer && !_this.wizardService.isPniWizardOpen() && haveQuestions) {
                _this.populateWizard(wizardContainer, populateByContainer);
            }
            else if (!_this.wizardService.isPniWizardOpen() && !haveQuestions && _this.questionsApiRetryCount < 30) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [3, 3];
                    case 2:
                        if (this.wizardService.isPniWizardOpen() && !answerValue) {
        ...
        this.dynamicImages = new dynamic_images_1.DynamicImages();
        this.wizardService = new wizard_service_1.WizardService();
    }
    PopulateWizard.prototype.fetchFirstQuestion = function () {
    ...
    PopulateWizard.prototype.initializeFirstQuestion = function () {
        var _this = this;
    ...
    PopulateWizard.prototype.setQuestionsQuery = function (questionSequence, answerValue, category) {
        this.questionList.push({ sequence: questionSequence, choice: answerValue, attrvalue: category });
    };
    PopulateWizard.prototype.configuringWizard = function (wizardContainer) {
        ...
        if (setPositioning && setPositioning == 'true')
            this.wizardService.wizardPositioning(wizardContainer.getAttribute("top"), wizardContainer.getAttribute("right"), wizardContainer.getAttribute("left"));
