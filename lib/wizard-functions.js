...
var WizardFunctions = (function () {
    function WizardFunctions() {
        ...
        this.handleOptionChange = function (e, currentQuestionSequence) {
            ...
            window.parent.postMessage(_this.questions[_this.questions.length - 1].Products, "https://satish0543.wixsite.com");
            var questionData = {
    ...
    WizardFunctions.prototype.fetchWithQuery = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, fetch(this.dynamicsQuestionApi + this.questionsApiQueryParams)];
                    case 1: return [2, _a.sent()];
                }
            });
        });
    };
    WizardFunctions.prototype.fetchNFirstQuestion = function () {
        return __awaiter(this, void 0, void 0, function () {
            var ques, newQuestions;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.fetchWithQuery()];
                    case 1:
                        ques = _a.sent();
                        return [4, ques.json()];
                    case 2:
    ...
    WizardFunctions.prototype.setQuestionsQuery = function (questionSequence, answerValue) {
        var query = '';
        var newQuery = String(questionSequence) + '/' + String(answerValue) + '/';
        this.questionQueryList.push(newQuery);
        this.questionQueryList.forEach(function (q) {
            query += q;
        });
        this.questionsApiQueryParams = query;
    };
    WizardFunctions.prototype.setNewQuestion = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    WizardFunctions.prototype.showNextQuestion = function (questionSequence, answerValue) {
        return __awaiter(this, void 0, void 0, function () {
